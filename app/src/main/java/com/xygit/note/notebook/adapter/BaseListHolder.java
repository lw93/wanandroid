...
public  class BaseListHolder {
    ...
    public BaseListHolder(final View view) {
     ...
     */
    @Deprecated
    public BaseListHolder setOnClickListener(@IdRes int viewId, View.OnClickListener listener) {
        View view = getView(viewId);
    ...
    public BaseListHolder addOnClickListener(@IdRes final int... viewIds) {
        for (int viewId : viewIds) {
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (baseAdapter.getOnItemChildClickListener() != null) {
                            baseAdapter.getOnItemChildClickListener().onItemChildClick(baseAdapter, v, baseAdapter.getAdapterView().getPositionForView(v));
                        }
                    }
                });
            }
     ...
     */
    @SuppressWarnings("unchecked")
    public BaseListHolder addOnLongClickListener(@IdRes final int... viewIds) {
        for (int viewId : viewIds) {
                ...
                view.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        return baseAdapter.getOnItemChildLongClickListener() != null &&
                                baseAdapter.getOnItemChildLongClickListener().onItemChildLongClick(baseAdapter, v, baseAdapter.getAdapterView().getPositionForView(v));
                    }
                });
            }
        }
     ...
     */
    @Deprecated
    public BaseListHolder setOnTouchListener(@IdRes int viewId, View.OnTouchListener listener) {
        View view = getView(viewId);
     ...
     */
    @Deprecated
    public BaseListHolder setOnLongClickListener(@IdRes int viewId, View.OnLongClickListener listener) {
        View view = getView(viewId);
     ...
     */
    @Deprecated
    public BaseListHolder setOnItemClickListener(@IdRes int viewId, AdapterView.OnItemClickListener listener) {
     ...
     * @return The BaseListHolder for chaining.
     */
    public BaseListHolder setOnItemLongClickListener(@IdRes int viewId, AdapterView.OnItemLongClickListener listener) {
        AdapterView view = getView(viewId);
     ...
     * @return The BaseListHolder for chaining.
     */
    public BaseListHolder setOnItemSelectedClickListener(@IdRes int viewId, AdapterView.OnItemSelectedListener listener) {
        AdapterView view = getView(viewId);
     ...
     */
    @SuppressWarnings("unchecked")
    public BaseListHolder setAdapter(@IdRes int viewId, BaseAdapter adapter) {
        AdapterView view = getView(viewId);
     ...
     * @return The BaseListHolder for chaining.
     */
    protected BaseListHolder setAdapter(BaseListAdapter adapter) {
